...
if("FALSE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /tmp/buildd/ros-hydro-pr2-description-1.11.4-0precise-20150101-0912)
  set(pr2_description_DEVEL_PREFIX /tmp/buildd/ros-hydro-pr2-description-1.11.4-0precise-20150101-0912/obj-x86_64-linux-gnu/devel)
  ...
  set(pr2_description_INSTALL_PREFIX /opt/ros/hydro)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Austin Hendrix <ahendrix@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Austin Hendrix <ahendrix@willowgarage.com>' to fix it.")
    endif()
